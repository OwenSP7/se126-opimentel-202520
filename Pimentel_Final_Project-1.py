...
while charClass != "1" and charClass != "2" and charClass != "3" and charClass != "4" and charClass != "5" and charClass != "6" and charClass != "7" and charClass != "8" and charClass != "9" and charClass != "10" and charClass != "11" and charClass != "12":
    print("***INVALID CLASS***")
    charClass = input(f"\nSelect your Class: ")
...
while statRollMethod != "1" and statRollMethod != "2" and statRollMethod != "3" :
...
while race != "1" and race != "2" and race != "3" and race != "4" and race != "5" and race != "6" and race != "7" and race != "8" and race != "9" :
    print("***INVALID RACE***")
    race = input(f"\nSelect your race: ")
...
while answer == "y":
    ...
    if level == 4 or level == 8 or level == 12 or level == 16 or level == 19:
        ...
        ## trap loop for invalid input
        while statUp != "1" and statUp != "2" and statUp != "3" and statUp != "4" and statUp != "5" and statUp != "6":
            print("***INVALID CHOICE***")
            statUp = input ("Choose the 1st stat you would like to improve?: ")
